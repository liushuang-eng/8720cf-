...
# 99 "/home/ls/samba_share/sdk-ameba-v7.1d/tools/arm-none-eabi-gcc/asdk/linux/newlib/lib/gcc/arm-none-eabi/6.5.0/include/stdarg.h" 3 4
...
# 66 "/home/ls/samba_share/sdk-ameba-v7.1d/tools/arm-none-eabi-gcc/asdk/linux/newlib/arm-none-eabi/include/stdio.h" 3
typedef __FILE FILE;
...
# 17 "../../../component/common/api/at_cmd/atcmd_wifi.c" 2
...
# 18 "../../../component/common/api/at_cmd/atcmd_wifi.c" 2
...
# 23 "../../../component/common/api/at_cmd/atcmd_wifi.c" 2
...
# 31 "../../../component/common/api/at_cmd/atcmd_wifi.c" 2
# 90 "../../../component/common/api/at_cmd/atcmd_wifi.c"
...
# 127 "../../../component/common/api/at_cmd/atcmd_wifi.c"
extern struct netif xnetif[((0) + (1) + 1)];
# 136 "../../../component/common/api/at_cmd/atcmd_wifi.c"
...
static void init_wifi_struct(void)
{
 ...
 wifi.ssid.len = 0;
 wifi.password = 
# 167 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
                ((void *)0)
# 167 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                    ;
 wifi.password_len = 0;
 wifi.key_id = -1;
 ...
 ap.ssid.len = 0;
 ap.password = 
# 172 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 172 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ;
 ap.password_len = 0;
 ap.channel = 1;
...
static void print_scan_result( rtw_scan_result_t* record )
{
    ...
    do{ snprintf(at_string, (1600), "%s,%d,%s,%d,""%02x:%02x:%02x:%02x:%02x:%02x""", record->SSID.val, record->channel, ( record->security == RTW_SECURITY_OPEN ) ? "Open" : ( record->security == RTW_SECURITY_WEP_PSK ) ? "WEP" : ( record->security == RTW_SECURITY_WPA_TKIP_PSK ) ? "WPA TKIP" : ( record->security == RTW_SECURITY_WPA_AES_PSK ) ? "WPA AES" : ( record->security == RTW_SECURITY_WPA2_AES_PSK ) ? "WPA2 AES" : ( record->security == RTW_SECURITY_WPA2_TKIP_PSK ) ? "WPA2 TKIP" : ( record->security == RTW_SECURITY_WPA2_MIXED_PSK ) ? "WPA2 Mixed" : ( record->security == RTW_SECURITY_WPA_WPA2_MIXED ) ? "WPA/WPA2 AES" : "Unknown", record->signal_strength, ((uint8_t*)(record->BSSID.octet))[0],((uint8_t*)(record->BSSID.octet))[1],((uint8_t*)(record->BSSID.octet))[2],((uint8_t*)(record->BSSID.octet))[3],((uint8_t*)(record->BSSID.octet))[4],((uint8_t*)(record->BSSID.octet))[5]); uart_at_send_string(at_string); }while(0)
# 192 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                                                                     ;
# 215 "../../../component/common/api/at_cmd/atcmd_wifi.c"
}
...
static rtw_result_t app_scan_result_handler( rtw_scan_handler_result_t* malloced_scan_result )
{
 ...
 if (malloced_scan_result->scan_complete != RTW_TRUE) {
  ...
  do{ snprintf(at_string, (1600), "\r\nAP : %d,", ++ApNum); uart_at_send_string(at_string); }while(0);
  ...
  do{ snprintf(at_string, (1600), "\r\n[ATWS] OK"); uart_at_send_string(at_string); }while(0);
...
exit:
 ...
 if(error_no==0)
  do{ snprintf(at_string, (1600), "\r\n[ATWD] OK"); uart_at_send_string(at_string); }while(0);
 else
  do{ snprintf(at_string, (1600), "\r\n[ATWD] ERROR:%d",error_no); uart_at_send_string(at_string); }while(0);
...
# 359 "../../../component/common/api/at_cmd/atcmd_wifi.c"
void fATWS(void *arg){
        char buf[32] = {0};
        uint8_t *channel_list = 
# 361 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
                          ((void *)0)
# 361 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                              ;
        uint8_t *pscan_config = 
# 362 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
                          ((void *)0)
# 362 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                              ;
        int num_channel = 0;
        int i, argc = 0;
        char *argv[12] = {0};
...
# 429 "../../../component/common/api/at_cmd/atcmd_wifi.c"
 if((ret = wifi_scan_networks(app_scan_result_handler, 
# 429 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
                                                      ((void *)0) 
# 429 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                                                           )) != RTW_SUCCESS){
...
exit:
# 446 "../../../component/common/api/at_cmd/atcmd_wifi.c"
 if(error_no)
  do{ snprintf(at_string, (1600), "\r\n[ATWS] ERROR:%d",error_no); uart_at_send_string(at_string); }while(0);
...
# 466 "../../../component/common/api/at_cmd/atcmd_wifi.c"
void fATWx(void *arg){
...
# 522 "../../../component/common/api/at_cmd/atcmd_wifi.c"
   do{ snprintf(at_string, (1600), "%02x:%02x:%02x:%02x:%02x:%02x,", mac[0], mac[1], mac[2], mac[3], mac[4], mac[5]); uart_at_send_string(at_string); }while(0) ;
   do{ snprintf(at_string, (1600), "%d.%d.%d.%d,", ip[0], ip[1], ip[2], ip[3]); uart_at_send_string(at_string); }while(0);
   do{ snprintf(at_string, (1600), "%d.%d.%d.%d", gw[0], gw[1], gw[2], gw[3]); uart_at_send_string(at_string); }while(0);
   ...
   if(setting.mode == RTW_MODE_AP || i == 1)
   {
    ...
    else
    {
     ...
     for( client_number=0; client_number < client_info.count; client_number++ )
     {
      ...
      do{ snprintf(at_string, (1600), "\r\nCLIENT : %d,""%02x:%02x:%02x:%02x:%02x:%02x""", client_number + 1, ((uint8_t*)(client_info.mac_list[client_number].octet))[0],((uint8_t*)(client_info.mac_list[client_number].octet))[1],((uint8_t*)(client_info.mac_list[client_number].octet))[2],((uint8_t*)(client_info.mac_list[client_number].octet))[3],((uint8_t*)(client_info.mac_list[client_number].octet))[4],((uint8_t*)(client_info.mac_list[client_number].octet))[5]); uart_at_send_string(at_string); }while(0);
  ...
  {
# 596 "../../../component/common/api/at_cmd/atcmd_wifi.c"
  }
 }
# 619 "../../../component/common/api/at_cmd/atcmd_wifi.c"
 do{ snprintf(at_string, (1600), "\r\n[ATW?] OK"); uart_at_send_string(at_string); }while(0);


}
# 1832 "../../../component/common/api/at_cmd/atcmd_wifi.c"
void fATPA(void *arg)
{
 int argc, error_no = 0;
 char *argv[12] = {0};
 ...
 if(!arg){
  do{ if((((1<<9)) & gDbgFlag) && (AT_DBG_ERROR <= gDbgLevel)){ do{ __wrap_printf("\r\n[ATPA] Usage: ATPA=<ssid>,<pwd>,<chl>,<hidden>[,<max_conn>]"); __wrap_printf("\r\n"); }while(0); } }while(0)
                                                                     ;
  error_no = 1;
  goto exit;
 }
 ...
 if(argv[1] != 
# 1869 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 1869 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){
 ...
 if(argv[2] != 
# 1885 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 1885 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){
 ...
 if(argv[3] != 
# 1901 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 1901 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){
 ...
 if(argv[4] != 
# 1911 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 1911 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){
 ...
 if(argv[5] != 
# 1921 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 1921 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){
 ...
 wifi_unreg_event_handler(WIFI_EVENT_DISCONNECT, atcmd_wifi_disconn_hdl);
# 1942 "../../../component/common/api/at_cmd/atcmd_wifi.c"
 wifi_off();
 vTaskDelay(20);
...
exit:
 ...
 if(error_no == 0)
  do{ snprintf(at_string, (1600), "\r\n[ATPA] OK"); uart_at_send_string(at_string); }while(0);
 else
  do{ snprintf(at_string, (1600), "\r\n[ATPA] ERROR:%d",error_no); uart_at_send_string(at_string); }while(0);
...
void fATPN(void *arg)
{
 ...
 uint8_t pscan_config;
 do{ snprintf(at_string, (1600), "\r\n[ATPN1] OK"); uart_at_send_string(at_string); }while(0);
 if(!arg){
  do{ if((((1<<9)) & gDbgFlag) && (AT_DBG_ERROR <= gDbgLevel)){ do{ __wrap_printf("\r\n[ATPN] Usage : ATPN=<ssid>,<pwd>[,<key_id>,<bssid>]"); __wrap_printf("\r\n"); }while(0); } }while(0)
                                                             ;
  error_no = 1;
  goto exit;
 }
 do{ snprintf(at_string, (1600), "\r\n[ATPN2] OK"); uart_at_send_string(at_string); }while(0);
 argc = parse_param(arg, argv);
 if( (argc < 2) || (argc > 5) ){
 ...
 if(argv[1] != 
# 2122 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 2122 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){
 ...
 if(argv[2] != 
# 2133 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 2133 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){
 ...
 if(argv[3] != 
# 2147 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 2147 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){
 ...
 if(argv[4] != 
# 2158 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 2158 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){
  if(strlen(argv[4]) != 12){
 ...
 if(mode == 3) {
  ...
  dhcps_deinit();
# 2183 "../../../component/common/api/at_cmd/atcmd_wifi.c"
  wifi_off();
  vTaskDelay(20);
 ...
 if((wifi.security_type == RTW_SECURITY_UNKNOWN)||(wifi.security_type == RTW_SECURITY_WPA2_AES_PSK))
 {
  ...
  while (1) {
   ...
   if(security_retry_count >= 3){
    __wrap_printf("Can't get AP security mode and channel.\n");
    error_no = 6;
    goto exit;
   }
  }
...
# 2229 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
                                                              ((void *)0)
# 2229 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                                                                  );
 } else {
  ret = wifi_connect((char*)wifi.ssid.val, wifi.security_type, (char*)wifi.password, wifi.ssid.len,
      wifi.password_len, wifi.key_id, 
# 2232 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
                                     ((void *)0)
# 2232 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                                         );
 }
...
exit:
 init_wifi_struct();
 if(error_no == 0){
  wifi_reg_event_handler(WIFI_EVENT_DISCONNECT, atcmd_wifi_disconn_hdl, 
# 2258 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
                                                                       ((void *)0)
# 2258 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                                                                           );
  do{ snprintf(at_string, (1600), "\r\n[ATPN] OK"); uart_at_send_string(at_string); }while(0);
 }
 else
  do{ snprintf(at_string, (1600), "\r\n[ATPN] ERROR:%d",error_no); uart_at_send_string(at_string); }while(0);
...
void fATPH(void *arg)
{
 ...
 if(!arg){
  do{ if((((1<<9)) & gDbgFlag) && (AT_DBG_ERROR <= gDbgLevel)){ do{ __wrap_printf("\r\n[ATPH] Usage : ATPH=<mode>,<enable>"); __wrap_printf("\r\n"); }while(0); } }while(0)
                                             ;
  error_no = 1;
  goto exit;
 }
 ...
 if(argv[1] != 
# 2288 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 2288 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){
 ...
 if(argv[2] != 
# 2297 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 2297 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){
...
exit:
 if(error_no==0)
  do{ snprintf(at_string, (1600), "\r\n[ATPH] OK"); uart_at_send_string(at_string); }while(0);
 else
  do{ snprintf(at_string, (1600), "\r\n[ATPH] ERROR:%d",error_no); uart_at_send_string(at_string); }while(0);
...
void fATPE(void *arg)
{
 ...
 if(!arg){
  do{ if((((1<<9)) & gDbgFlag) && (AT_DBG_ERROR <= gDbgLevel)){ do{ __wrap_printf("\r\n[ATPE] Usage : ATPE=<ip>(,<gateway>,<mask>)"); __wrap_printf("\r\n"); }while(0); } }while(0)
                                                     ;
  error_no = 1;
  goto exit;
 }
 ...
 if(argv[1] != 
# 2342 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 2342 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){
  ip4_addr = ipaddr_addr(argv[1]);
  sta_ip[0] = (unsigned char) ip4_addr & 0xff;
  sta_ip[1] = (unsigned char) (ip4_addr >> 8) & 0xff;
  sta_ip[2] = (unsigned char) (ip4_addr >> 16) & 0xff;
  sta_ip[3] = (unsigned char) (ip4_addr >> 24) & 0xff;
 }
 else{
 ...
 if(argv[2] != 
# 2355 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 2355 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){
  ip4_addr = ipaddr_addr(argv[2]);
  sta_gw[0] = (unsigned char) ip4_addr & 0xff;
  sta_gw[1] = (unsigned char) (ip4_addr >> 8) & 0xff;
  sta_gw[2] = (unsigned char) (ip4_addr >> 16) & 0xff;
  sta_gw[3] = (unsigned char) (ip4_addr >> 24) & 0xff;
 }
 else{
  sta_gw[0] = sta_ip[0];
  sta_gw[1] = sta_ip[1];
 ...
 if(argv[3] != 
# 2369 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 2369 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){
  ip4_addr = ipaddr_addr(argv[3]);
  sta_netmask[0] = (unsigned char) ip4_addr & 0xff;
  sta_netmask[1] = (unsigned char) (ip4_addr >> 8) & 0xff;
  sta_netmask[2] = (unsigned char) (ip4_addr >> 16) & 0xff;
  sta_netmask[3] = (unsigned char) (ip4_addr >> 24) & 0xff;
 }
 else{
  sta_netmask[0] = 255;
  sta_netmask[1] = 255;
...
exit:
 if(error_no==0)
  do{ snprintf(at_string, (1600), "\r\n[ATPE] OK"); uart_at_send_string(at_string); }while(0);
 else
  do{ snprintf(at_string, (1600), "\r\n[ATPE] ERROR:%d",error_no); uart_at_send_string(at_string); }while(0);
...
void fATPF(void *arg)
{
 ...
 if(!arg){
  do{ if((((1<<9)) & gDbgFlag) && (AT_DBG_ERROR <= gDbgLevel)){ do{ __wrap_printf("\r\n[ATPF] Usage : ATPF=<start_ip>,<end_ip>,<ip>(,<gateway>,<mask>)"); __wrap_printf("\r\n"); }while(0); } }while(0)
                                                                         ;
  error_no = 1;
  goto exit;
 }
 ...
 if(argv[1] != 
# 2415 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 2415 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){

  (((&start_ip))->addr = (ipaddr_addr(argv[1])));
 ...
 if(argv[2] != 
# 2428 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 2428 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){

  (((&end_ip))->addr = (ipaddr_addr(argv[2])));
 ...
 if(argv[3] != 
# 2443 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 2443 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){
  ip4_addr = ipaddr_addr(argv[3]);
  ap_ip[0] = (unsigned char) ip4_addr & 0xff;
  ap_ip[1] = (unsigned char) (ip4_addr >> 8) & 0xff;
  ap_ip[2] = (unsigned char) (ip4_addr >> 16) & 0xff;
  ap_ip[3] = (unsigned char) (ip4_addr >> 24) & 0xff;
 }
 else{
...
exit:
 if(error_no==0)
  do{ snprintf(at_string, (1600), "\r\n[ATPF] OK"); uart_at_send_string(at_string); }while(0);
 else
  do{ snprintf(at_string, (1600), "\r\n[ATPF] ERROR:%d",error_no); uart_at_send_string(at_string); }while(0);
...
void atcmd_wifi_write_info_to_flash(rtw_wifi_setting_t *setting, int enable)
{
 ...
 data_to_flash = (struct atcmd_wifi_conf *)pvPortMalloc(sizeof(struct atcmd_wifi_conf));
 ...
 if(data_to_flash) {
  if(enable){
   ...
   if(setting->mode == RTW_MODE_STA || setting->mode == RTW_MODE_STA_AP){
    ...
    if(data_to_flash->reconn_num < 0 || data_to_flash->reconn_num > (1) ||
     data_to_flash->reconn_last_index < 0 || data_to_flash->reconn_last_index > (1)
    ){
    ...
    for(i = 0; i < data_to_flash->reconn_num; i++){
     if(memcmp((uint8_t *)&reconn, (uint8_t *)&(data_to_flash->reconn[i]), sizeof(struct wlan_fast_reconnect)) == 0) {
      do{ if((((1<<9)) & gDbgFlag) && (AT_DBG_ALWAYS <= gDbgLevel)){ do{ __wrap_printf("the same profile found in flash"); __wrap_printf("\r\n"); }while(0); } }while(0)
                                         ;
      found = 1;
      break;
     }
    ...
    if(!found){
     ...
     if(data_to_flash->reconn_last_index >= (1))
      data_to_flash->reconn_last_index -= (1);
     ...
     if(data_to_flash->reconn_num > (1))
      data_to_flash->reconn_num = (1);
     write_needed = 1;
    }
   }
...
# 2600 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
 ((void *)0)
# 2600 "../../../component/common/api/at_cmd/atcmd_wifi.c"
     ,
  0,
  -1
 };
 ...
 if(data){
  ...
  for(i = 0; i < data->reconn_num; i++){
   ...
   ret = wifi_connect((char*)wifi.ssid.val, wifi.security_type, (char*)wifi.password, wifi.ssid.len,
    wifi.password_len, wifi.key_id, 
# 2676 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
                                   ((void *)0)
# 2676 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                                       );
   if(ret == RTW_SUCCESS){
...
exit:
 if(ret == 0)
  wifi_reg_event_handler(WIFI_EVENT_DISCONNECT, atcmd_wifi_disconn_hdl, 
# 2687 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
                                                                       ((void *)0)
# 2687 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                                                                           );
 if(data)
...
void fATPG(void *arg)
{
 ...
 if(!arg){
  do{ if((((1<<9)) & gDbgFlag) && (AT_DBG_ERROR <= gDbgLevel)){ do{ __wrap_printf("\r\n[ATPG] Usage : ATPG=<enable>"); __wrap_printf("\r\n"); }while(0); } }while(0)
                                      ;
  error_no = 1;
  goto exit;
 }
 ...
 if(argv[1] != 
# 2715 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 2715 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){
# 2730 "../../../component/common/api/at_cmd/atcmd_wifi.c"
  rtw_wifi_setting_t setting;
  ...
  if(enable == 1){
   ...
   if(wifi_get_setting((const char*)ifname[0],&setting)){
    do{ if((((1<<9)) & gDbgFlag) && (AT_DBG_ERROR <= gDbgLevel)){ do{ __wrap_printf("wifi_get_setting fail"); __wrap_printf("\r\n"); }while(0); } }while(0)
                             ;
    error_no = 3;
    goto exit;
   }
...
exit:
 if(error_no==0)
  do{ snprintf(at_string, (1600), "\r\n[ATPG] OK"); uart_at_send_string(at_string); }while(0);
 else
  do{ snprintf(at_string, (1600), "\r\n[ATPG] ERROR:%d",error_no); uart_at_send_string(at_string); }while(0);
...
void fATPM(void *arg)
{
 ...
 if(!arg){
  do{ if((((1<<9)) & gDbgFlag) && (AT_DBG_ERROR <= gDbgLevel)){ do{ __wrap_printf("\r\n[ATPM] Usage : ATPM=<mac>"); __wrap_printf("\r\n"); }while(0); } }while(0)
                                   ;
  error_no = 1;
  goto exit;
 }
 ...
 if(argv[1] != 
# 2778 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 2778 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){
  if(strlen(argv[1]) != 12){
...
exit:
 if(error_no==0)
  do{ snprintf(at_string, (1600), "\r\n[ATPM] OK"); uart_at_send_string(at_string); }while(0);
 else
  do{ snprintf(at_string, (1600), "\r\n[ATPM] ERROR:%d",error_no); uart_at_send_string(at_string); }while(0);
...
void fATPW(void *arg)
{
 ...
 if(!arg){
  do{ if((((1<<9)) & gDbgFlag) && (AT_DBG_ERROR <= gDbgLevel)){ do{ __wrap_printf("\r\n[ATPW] Usage : ATPW=<mode>"); __wrap_printf("\r\n"); }while(0); } }while(0)
                                    ;
  error_no = 1;
  goto exit;
 }
 ...
 if(argv[1] != 
# 2817 "../../../component/common/api/at_cmd/atcmd_wifi.c" 3 4
              ((void *)0)
# 2817 "../../../component/common/api/at_cmd/atcmd_wifi.c"
                  ){
...
exit:
 if(error_no==0)
  do{ snprintf(at_string, (1600), "\r\n[ATPW] OK"); uart_at_send_string(at_string); }while(0);
 else
  do{ snprintf(at_string, (1600), "\r\n[ATPW] ERROR:%d",error_no); uart_at_send_string(at_string); }while(0);

 return;
}

void print_wlan_help(void *arg){
 do{ snprintf(at_string, (1600), "\r\nWLAN AT COMMAND SET:"); uart_at_send_string(at_string); }while(0);
 do{ snprintf(at_string, (1600), "\r\n=============================="); uart_at_send_string(at_string); }while(0);
 do{ snprintf(at_string, (1600), "\r\n1. Wlan Scan for Network Access Point"); uart_at_send_string(at_string); }while(0);
 do{ snprintf(at_string, (1600), "\r\n   # ATWS"); uart_at_send_string(at_string); }while(0);
 do{ snprintf(at_string, (1600), "\r\n2. Connect to an AES AP"); uart_at_send_string(at_string); }while(0);
 do{ snprintf(at_string, (1600), "\r\n   # ATPN=<ssid>,<pwd>,<key_id>(,<bssid>)"); uart_at_send_string(at_string); }while(0);
 do{ snprintf(at_string, (1600), "\r\n3. Create an AES AP"); uart_at_send_string(at_string); }while(0);
 do{ snprintf(at_string, (1600), "\r\n   # ATPA=<ssid>,<pwd>,<chl>,<hidden>"); uart_at_send_string(at_string); }while(0);
}
# 2980 "../../../component/common/api/at_cmd/atcmd_wifi.c"
log_item_t at_wifi_items[ ] = {
# 3065 "../../../component/common/api/at_cmd/atcmd_wifi.c"
 {"ATPA", fATPA,},
 {"ATPN", fATPN,},
 {"ATPH", fATPH,},
 {"ATPE", fATPE,},
...
void print_wifi_at(void *arg){
 ...
 for(index = 0; index < cmd_len; index++)
  do{ snprintf(at_string, (1600), "\r\n%s", at_wifi_items[index].log_cmd); uart_at_send_string(at_string); }while(0);
}
