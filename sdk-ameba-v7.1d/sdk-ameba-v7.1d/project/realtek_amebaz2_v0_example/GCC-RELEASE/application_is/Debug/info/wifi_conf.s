...
.LBB42:
	...
	movs	r0, #1
	.loc 1 446 0
	ldrb	r6, [sp, #45]	@ zero_extendqisi2
.LVL493:
	.loc 1 452 0
	bl	device_mutex_lock
.LVL494:
...
ap_bssid:
	.space	6
	.section	.bss.event_init.23910,"aw",%nobits
	.align	2
	.set	.LANCHOR6,. + 0
	.type	event_init.23910, %object
	.size	event_init.23910, 4
event_init.23910:
	.space	4
...
join_user_data:
	.space	4
	.section	.bss.param.24221,"aw",%nobits
	.align	2
	.set	.LANCHOR4,. + 0
	.type	param.24221, %object
	.size	param.24221, 24
param.24221:
	.space	24
...
error_flag:
	.word	6
	.section	.rodata.__FUNCTION__.23933,"a",%progbits
	.set	.LANCHOR7,. + 0
	.type	__FUNCTION__.23933, %object
	.size	__FUNCTION__.23933, 14
__FUNCTION__.23933:
	.ascii	"wifi_set_mode\000"
	.section	.rodata.__func__.23724,"a",%progbits
	.set	.LANCHOR8,. + 0
	.type	__func__.23724, %object
	.size	__func__.23724, 27
__func__.23724:
...
.Letext0:
	...
	.file 83 "/home/ls/8720cf/sdk-ameba-v7.1d/tools/arm-none-eabi-gcc/asdk/linux/newlib/arm-none-eabi/include/string.h"
