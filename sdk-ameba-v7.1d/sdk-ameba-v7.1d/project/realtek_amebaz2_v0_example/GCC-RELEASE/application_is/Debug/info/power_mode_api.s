...
.Ltext0:
	...
	.section	.text.hal_gpio_pull_ctrl.constprop.0,"ax",%progbits
	.align	1
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	hal_gpio_pull_ctrl.constprop.0, %function
hal_gpio_pull_ctrl.constprop.0:
.LFB562:
...
.L2:
	...
	.cfi_endproc
.LFE562:
	.size	hal_gpio_pull_ctrl.constprop.0, .-hal_gpio_pull_ctrl.constprop.0
...
DeepSleep:
.LFB559:
	.file 2 "../../../component/common/mbed/targets/hal/rtl8710c/power_mode_api.c"
	.loc 2 55 0
	.cfi_startproc
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
.LVL2:
	...
	mov	r6, r2
	.loc 2 56 0
	bl	hal_gpio_pull_ctrl.constprop.0
.LVL3:
	.loc 2 57 0
	mov	r2, r6
	mov	r1, r5
