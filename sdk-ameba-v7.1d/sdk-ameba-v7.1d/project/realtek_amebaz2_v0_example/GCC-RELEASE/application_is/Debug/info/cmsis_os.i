    ...
    if (event_handle) {
        if (inHandlerMode()) {
            uxBits_ret = xEventGroupGetBitsFromISR(event_handle);
                      ...
                      xTimerPendFunctionCallFromISR( vEventGroupClearBitsCallback, ( void * ) event_handle, ( uint32_t ) signals, 
# 625 "../../../component/os/freertos/cmsis_os.c" 3 4
                     ((void *)0) 
# 625 "../../../component/os/freertos/cmsis_os.c"
                     )
