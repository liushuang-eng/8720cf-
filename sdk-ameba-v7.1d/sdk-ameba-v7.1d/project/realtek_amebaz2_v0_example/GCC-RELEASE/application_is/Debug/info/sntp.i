...
# 212 "../../../component/common/network/sntp/sntp.c" 3 4
                                                ((void *)0)
# 212 "../../../component/common/network/sntp/sntp.c"
                                                    )
  return -1;
...
# 308 "../../../component/common/network/sntp/sntp.c"
# 1 "../../../component/common/network/lwip/lwip_v2.0.2/port/realtek/arch/bpstruct.h" 1
# 34 "../../../component/common/network/lwip/lwip_v2.0.2/port/realtek/arch/bpstruct.h"
#pragma pack(1)
# 309 "../../../component/common/network/sntp/sntp.c" 2
...
# 36 "../../../component/common/network/lwip/lwip_v2.0.2/port/realtek/arch/epstruct.h"
#pragma pack()
# 327 "../../../component/common/network/sntp/sntp.c" 2
...
# 347 "../../../component/common/network/sntp/sntp.c"
static u32_t sntp_retry_timeout;
# 367 "../../../component/common/network/sntp/sntp.c"
static void
sntp_process(u32_t *receive_timestamp)
{
  ...
  ;
# 388 "../../../component/common/network/sntp/sntp.c"
}
...
# 411 "../../../component/common/network/sntp/sntp.c"
}
...
# 427 "../../../component/common/network/sntp/sntp.c" 3 4
                                               ((void *)0)
# 427 "../../../component/common/network/sntp/sntp.c"
                                                   );
...
# 477 "../../../component/common/network/sntp/sntp.c"
static void
...
# 489 "../../../component/common/network/sntp/sntp.c" 3 4
                                     ((void *)0)
# 489 "../../../component/common/network/sntp/sntp.c"
                                         );
  sys_untimeout(sntp_request, 
# 490 "../../../component/common/network/sntp/sntp.c" 3 4
                             ((void *)0)
# 490 "../../../component/common/network/sntp/sntp.c"
                                 );
...
# 526 "../../../component/common/network/sntp/sntp.c"
          {
...
# 547 "../../../component/common/network/sntp/sntp.c" 3 4
                                                       ((void *)0)
# 547 "../../../component/common/network/sntp/sntp.c"
                                                           );
    ...
    sntp_retry(
# 552 "../../../component/common/network/sntp/sntp.c" 3 4
                        ((void *)0)
# 552 "../../../component/common/network/sntp/sntp.c"
                            );
  } else {

    sntp_retry(
# 555 "../../../component/common/network/sntp/sntp.c" 3 4
              ((void *)0)
# 555 "../../../component/common/network/sntp/sntp.c"
                  );
  }
}
...
sntp_send_request(ip_addr_t *server_addr)
{
  ...
  if (p != 
# 568 "../../../component/common/network/sntp/sntp.c" 3 4
          ((void *)0)
# 568 "../../../component/common/network/sntp/sntp.c"
              ) {
...
# 578 "../../../component/common/network/sntp/sntp.c" 3 4
                                                               ((void *)0)
# 578 "../../../component/common/network/sntp/sntp.c"
                                                                   );
...
# 587 "../../../component/common/network/sntp/sntp.c" 3 4
                                                        ((void *)0)
# 587 "../../../component/common/network/sntp/sntp.c"
                                                            );
  }
}
...
sntp_dns_found(const char* hostname, ip_addr_t *ipaddr, void *arg)
{
  ...
  if (ipaddr != 
# 601 "../../../component/common/network/sntp/sntp.c" 3 4
               ((void *)0)
# 601 "../../../component/common/network/sntp/sntp.c"
                   ) {
    ...
    ;
    sntp_retry(
# 608 "../../../component/common/network/sntp/sntp.c" 3 4
                        ((void *)0)
# 608 "../../../component/common/network/sntp/sntp.c"
                            );
  }
}
...
# 629 "../../../component/common/network/sntp/sntp.c" 3 4
                                       ((void *)0)
# 629 "../../../component/common/network/sntp/sntp.c"
                                           );
...
{
  if (sntp_pcb == 
# 657 "../../../component/common/network/sntp/sntp.c" 3 4
                 ((void *)0)
# 657 "../../../component/common/network/sntp/sntp.c"
                     ) {
    sntp_retry_timeout = 3000;
    sntp_pcb = udp_new();
    do { if (!(sntp_pcb != 
# 660 "../../../component/common/network/sntp/sntp.c" 3 4
   ((void *)0)
# 660 "../../../component/common/network/sntp/sntp.c"
   )) { ; }} while(0);
    if (sntp_pcb != 
# 661 "../../../component/common/network/sntp/sntp.c" 3 4
                   ((void *)0)
# 661 "../../../component/common/network/sntp/sntp.c"
                       ) {
      udp_recv(sntp_pcb, (udp_recv_fn)sntp_recv, 
# 662 "../../../component/common/network/sntp/sntp.c" 3 4
                                                ((void *)0)
# 662 "../../../component/common/network/sntp/sntp.c"
                                                    );



      sntp_request(
# 666 "../../../component/common/network/sntp/sntp.c" 3 4
                  ((void *)0)
# 666 "../../../component/common/network/sntp/sntp.c"
                      );
...
{
  if (sntp_pcb != 
# 678 "../../../component/common/network/sntp/sntp.c" 3 4
                 ((void *)0)
# 678 "../../../component/common/network/sntp/sntp.c"
                     ) {
    sys_untimeout(sntp_request, 
# 679 "../../../component/common/network/sntp/sntp.c" 3 4
                               ((void *)0)
# 679 "../../../component/common/network/sntp/sntp.c"
                                   );
    udp_remove(sntp_pcb);
    sntp_pcb = 
# 681 "../../../component/common/network/sntp/sntp.c" 3 4
              ((void *)0)
# 681 "../../../component/common/network/sntp/sntp.c"
                  ;
  }
}
