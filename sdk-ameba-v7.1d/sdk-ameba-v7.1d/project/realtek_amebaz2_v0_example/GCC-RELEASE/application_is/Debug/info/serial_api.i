...
int32_t serial_recv_blocked (serial_t *obj, char *prxbuf, uint32_t len, uint32_t timeout_ms)
{
    ...
    if (obj->uart_adp.rx_status != HAL_UART_STATUS_OK) {
        do { if (__builtin_expect (((*(utility_stubs.config_debug_warn)) & 0x00000800), 0)) (stdio_printf_stubs.rt_printfl("\r" "[UART Wrn]" "serial_recv_blocked: status(%d)\n", obj->uart_adp.rx_status));}while(0);
    }
...
int32_t serial_recv_stream_dma_timeout (serial_t *obj, char *prxbuf, uint32_t len, uint32_t timeout_ms, void *force_cs)
{
    ...
    if ((ret == (0x00)) && (timeout_ms > 0)) {
        ...
        while (obj->uart_adp.state & HAL_UART_STATE_DMARX_BUSY) {
            ...
            if (task_yield != 
# 376 "../../../component/common/mbed/targets/hal/rtl8710c/serial_api.c" 3 4
                             ((void *)0)
# 376 "../../../component/common/mbed/targets/hal/rtl8710c/serial_api.c"
                                 ) {
               task_yield();
            }
        }
...
int32_t serial_recv_stream_timeout (serial_t *obj, char *prxbuf, uint32_t len, uint32_t timeout_ms, void *force_cs)
{
    ...
    if ((ret == (0x00)) && (timeout_ms > 0)) {
        ...
        while (obj->uart_adp.state & HAL_UART_STATE_RX_BUSY) {
            ...
            if (task_yield != 
# 433 "../../../component/common/mbed/targets/hal/rtl8710c/serial_api.c" 3 4
                             ((void *)0)
# 433 "../../../component/common/mbed/targets/hal/rtl8710c/serial_api.c"
                                 ) {
               task_yield();
            }
        }
...
# 457 "../../../component/common/mbed/targets/hal/rtl8710c/serial_api.c"
uint8_t serial_raed_lsr(serial_t *obj)
{
    return obj->uart_adp.base_addr->lsr;
}
# 471 "../../../component/common/mbed/targets/hal/rtl8710c/serial_api.c"
