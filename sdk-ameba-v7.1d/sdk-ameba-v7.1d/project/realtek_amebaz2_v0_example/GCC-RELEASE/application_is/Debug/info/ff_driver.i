# 1 "../../../component/common/file_system/fatfs/fatfs_ext/src/ff_driver.c"
...
# 2 "../../../component/common/file_system/fatfs/fatfs_ext/src/ff_driver.c" 2
...
# 3 "../../../component/common/file_system/fatfs/fatfs_ext/src/ff_driver.c" 2
...
int FATFS_RegisterDiskDriver(ll_diskio_drv *drv){
 ...
 if(disk.nbr < 1)
 {
   drv->drv_num = disk.nbr;
   disk.drv[disk.nbr] = drv;
   disk.nbr++;
   drv_num = drv->drv_num;
 }
 __wrap_printf("FATFS Register: disk driver %d\n\r", drv_num);
 return drv_num;
}
