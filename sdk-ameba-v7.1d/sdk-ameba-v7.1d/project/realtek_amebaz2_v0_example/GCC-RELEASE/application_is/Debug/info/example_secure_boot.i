...
static void efuse_secure_boot_task(void *param)
{
 ...
 for(i=0; i<32; i+=8){
    ...
    vTaskDelete(
# 183 "../../../component/common/example/secure_boot/example_secure_boot.c" 3 4
               ((void *)0)
# 183 "../../../component/common/example/secure_boot/example_secure_boot.c"
                   );

exit:
    (stdio_printf_stubs.rt_printfl("efuse secure boot: Test Fail!\r\n"));
    vTaskDelete(
# 187 "../../../component/common/example/secure_boot/example_secure_boot.c" 3 4
               ((void *)0)
# 187 "../../../component/common/example/secure_boot/example_secure_boot.c"
                   );
}
...
# 192 "../../../component/common/example/secure_boot/example_secure_boot.c" 3 4
                                                                                        ((void *)0)
# 192 "../../../component/common/example/secure_boot/example_secure_boot.c"
                                                                                            , ( ( UBaseType_t ) 0U ) + 1, 
# 192 "../../../component/common/example/secure_boot/example_secure_boot.c" 3 4
                                                                                                                    ((void *)0)
# 192 "../../../component/common/example/secure_boot/example_secure_boot.c"
    ...
    if(rtw_get_scheduler_state() == 0)
        ...
        vTaskDelete(
# 199 "../../../component/common/example/secure_boot/example_secure_boot.c" 3 4
                   ((void *)0)
# 199 "../../../component/common/example/secure_boot/example_secure_boot.c"
                       );
}
