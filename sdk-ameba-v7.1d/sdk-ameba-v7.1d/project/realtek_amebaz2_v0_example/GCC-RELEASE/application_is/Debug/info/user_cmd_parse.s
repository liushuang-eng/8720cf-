...
.Ltext0:
	...
	.section	.text.user_cmd_find_end_of_word,"ax",%progbits
	.align	1
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	user_cmd_find_end_of_word, %function
...
.L1:
	...
	.cfi_endproc
.LFE2:
	.size	user_cmd_find_end_of_word, .-user_cmd_find_end_of_word
	.section	.text.cmd_clear_screen,"ax",%progbits
	.align	1
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	cmd_clear_screen, %function
cmd_clear_screen:
.LFB11:
	.loc 1 373 0
	.cfi_startproc
...
.L10:
	...
	.cfi_endproc
.LFE11:
	.size	cmd_clear_screen, .-cmd_clear_screen
...
.L143:
	...
	.loc 1 542 0
	adds	r2, r4, r3
	ldrb	r2, [r2, #289]	@ zero_extendqisi2
	.loc 1 544 0
	adds	r1, r1, #1
	add	r1, r1, r4
	.loc 1 542 0
...
.LFE13:
	...
	.section	.rodata.cmd_clear_screen.str1.1,"aMS",%progbits,1
.LC0:
	.ascii	"%s\000"
.LC1:
	.ascii	"\010 \010\000"
	.section	.rodata.user_cmd_collect.str1.1,"aMS",%progbits,1
.LC2:
	.ascii	"\015\012\000"
.LC3:
	.ascii	"  *\000"
...
.LC31:
	.ascii	"?\000"
	.section	.rodata.user_cmd_init.str1.1,"aMS",%progbits,1
.LC32:
