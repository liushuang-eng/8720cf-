...
# 61 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.h"
...
update_ota_exit:
 ...
 if(param)
  update_free(param);
 TaskOTA = 
# 231 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
          ((void *)0)
# 231 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
              ;
 ...
 vTaskDelete(
# 238 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
            ((void *)0)
# 238 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
                );
 return;
}
...
int update_ota_local(char *ip, int port){
 ...
 if(pUpdateCfg == 
# 250 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
                 ((void *)0)
# 250 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
                     ){
...
# 284 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
                       ((void *)0)
# 284 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
                           ;
static int redirect_len;
static uint16_t redirect_server_port;
static char *redirect_server_host = 
# 287 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
                                   ((void *)0)
# 287 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
                                       ;
static char *redirect_resource = 
# 288 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
                                ((void *)0)
# 288 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
                                    ;
int parser_url( char *url, char *host, uint16_t *port, char *resource)
{
 ...
 if(url){
  char *http = 
# 293 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
              ((void *)0)
# 293 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
                  , *pos = 
# 293 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
                           ((void *)0)
# 293 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
  ...
  __wrap_printf("server: %s\n\r", host);
  __wrap_printf("port: %d\n\r", *port);
  ...
  __wrap_printf("resource: %s\n\r", resource);

  return 0;
 }
 return -1;
}
# 338 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
int update_ota_http_connect_server(int server_socket, char *host, int port){
 struct sockaddr_in server_addr;
 ...
 if(server_socket < 0){
  ...
  return -1;
    ...
    if(server == 
# 349 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
                ((void *)0)
# 349 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
                    ){
  ...
  return -1;
    ...
    memcpy(&server_addr.sin_addr.s_addr,server->h_addr_list[0],4);
...
# 378 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
int parse_http_response(uint8_t *response, uint32_t response_len, http_response_result_t *result) {
 ...
 if(0 == result->parse_status){
  ...
  {
   char *tmp=
# 407 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
            ((void *)0)
# 407 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
                ;
   const uint8_t *location1 = (uint8_t *)"LOCATION";
   const uint8_t *location2 = (uint8_t *)"Location";
   __wrap_printf("response 302:%s \r\n", response);
   ...
   if((tmp =strstr((char const*)response, (char const*)location1)) ||(tmp=strstr((char const*)response, (char const*)location2)))
   {
    ...
    __wrap_printf("Location len = %d\r\n", redirect_len);
    if(redirect ==
# 416 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
                 ((void *)0)
# 416 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
                     )
    {
     redirect = update_malloc(redirect_len);
     if(redirect == 
# 419 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
                   ((void *)0)
# 419 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
                       )
     {
      return -1;
     }
...
# 428 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
                            ((void *)0)
# 428 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
                                )
   {
    redirect_server_host = update_malloc(redirect_len);
    if(redirect_server_host == 
# 431 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
                              ((void *)0)
# 431 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
                                  )
    {
     return -1;
    }
...
# 437 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
                         ((void *)0)
# 437 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
                             )
   {
    redirect_resource = update_malloc(redirect_len);
    if(redirect_resource == 
# 440 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
                           ((void *)0)
# 440 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
                               )
    {
     return -1;
    }
 ...
 if(3 == result->parse_status){
  ...
  if (3 == result->parse_status) {
   result->header_bak = update_malloc(32 + 1);
   memset(result->header_bak, 0, strlen((char const*)result->header_bak));
   memcpy(result->header_bak, response + response_len - 32, 32);
  }
 }
...
int http_update_ota(char *host, int port, char *resource)
{
 int server_socket = -1;
 unsigned char *buf = 
# 537 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
                     ((void *)0)
# 537 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
                         , *request = 
# 537 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
                                      ((void *)0)
# 537 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
...
restart_http_ota:
 ...
 if(NewFWAddr != ~0x0){
  ...
  ret = lwip_write(server_socket,request,strlen((char const*)request));
  if(ret < 0){
  ...
  while (3 >= rsp_result.parse_status){
   if(0 == rsp_result.parse_status){
    memset(buf, 0, 4096);
    read_bytes = lwip_read(server_socket,buf,4096);
    if(read_bytes <= 0){
     __wrap_printf("\n\r[%s] Read socket failed", __FUNCTION__);
     goto update_ota_exit;
    }
    ...
    memset(buf, 0, 4096);
    memcpy(buf, rsp_result.header_bak, 32);
    update_free(rsp_result.header_bak);
    rsp_result.header_bak = 
# 603 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c" 3 4
                           ((void *)0)
# 603 "../../../component/soc/realtek/8710c/misc/platform/ota_8710c.c"
                               ;
    read_bytes = lwip_read(server_socket,buf+ 32,(4096 - 32));
    ...
    if(parse_http_response(buf, read_bytes + 32, &rsp_result) == -1){
     goto update_ota_exit;
    }
   }
  }
  ...
  if(read_bytes > 0){
   ...
   memset(buf + read_bytes, 0, 4096 - read_bytes);
   goto skip_read;
  }
  ...
  while (idx < NewFWLen){
   ...
   while(read_bytes < data_len){
    read_rtn = lwip_read(server_socket,&buf[read_bytes],data_len-read_bytes);
    if(read_rtn <= 0){
     __wrap_printf("\n\r[%s] Read socket failed", __FUNCTION__);
     goto update_ota_exit;
    }
